...
{
    /// <inheritdoc />
    public partial class AddDocumentFeatureTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(5834), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(5846), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(5850), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(5854), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 10, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6257), true, new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6256), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 8, 14, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6125), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 8, 14, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6116), 1, new DateTime(2026, 11, 12, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6121), new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6126) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 8, 14, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6225), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 8, 14, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6228), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 8, 14, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6158), "Create entity relationship diagram and database design", new DateTime(2026, 8, 24, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6156), 2, 1, 2, "Design database schema", new DateTime(2026, 8, 24, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6159) },
                    { 2, 4, 2, new DateTime(2026, 8, 19, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6165), "Set up Microsoft Entra ID authentication", new DateTime(2026, 9, 18, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6163), 3, 1, 1, "Implement authentication", new DateTime(2026, 9, 13, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6166) },
                    { 3, 4, 2, new DateTime(2026, 8, 24, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6171), "Design user interface mockups for all main pages", new DateTime(2026, 9, 23, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6169), 1, 1, 0, "Create UI mockups", new DateTime(2026, 8, 24, 11, 54, 4, 528, DateTimeKind.Utc).AddTicks(6172) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentActivityLogs_DocumentId_CreatedDate",
                table: "DocumentActivityLogs",
                columns: new[] { "DocumentId", "CreatedDate" });
